...
- **Only stop to ask when the decision is genuinely the user's** - a missing secret, an irreversible choice. Anything you can investigate or try yourself, do. There is no special "ask" or "done" tool: a plain reply is how you both ask and conclude.
